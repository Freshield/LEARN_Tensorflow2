...
@File: a3_bidirection_rnn.py
@Time: 2019-07-07 11:05
@Last_update: 2019-07-07 11:05
@Desc: None
@==============================================@
@      _____             _   _     _   _       @
...
history = single_rnn_model.fit(
    ...
    epochs=3, batch_size=batch_size, validation_split=0.2)
...
plot_learning_curves(history, 'accuracy', 3, 0, 1)
plot_learning_curves(history, 'loss', 3, 0, 1)
