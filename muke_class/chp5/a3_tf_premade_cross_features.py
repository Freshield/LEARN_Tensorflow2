...
@File: a3_tf_premade_cross_features.py
@Time: 2019-06-06 14:57
@Last_update: 2019-06-06 14:57
@Desc: None
@==============================================@
@      _____             _   _     _   _       @
...
output_dir = 'data/baseline_model_cross_feature'
...
print('linear')
linear_output_dir = 'data/linear_model_cross_feature'
...
print('dnn')
dnn_output_dir = 'data/dnn_model_cross_feature'
